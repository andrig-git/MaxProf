(() => {
    ...
    (() => {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if ("items" === showMoreType) {
                        ...
                        const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 5;
        ...
        function initSliders() {
            let tumbrSlider;
            if (document.querySelector(".tumbr__slider")) tumbrSlider = new core(".tumbr__slider", {
                modules: [ Thumb ],
                spaceBetween: 0,
                slidesPerView: 4,
                freeMode: true,
            ...
            if (document.querySelector(".works__slider ")) {
                new core(".works__slider ", {
                    ...
                    navigation: {
                        prevEl: ".works__arrow-left",
                        nextEl: ".works__arrow-right"
                    },
                    on: {}
                });
            }
            ...
            if (document.querySelector(".masters__slider ")) {
                new core(".masters__slider ", {
                    ...
                    centeredSlides: true,
                    navigation: {
                        prevEl: ".masters__arrow-left",
                        nextEl: ".masters__arrow-right"
                    },
                    pagination: {
